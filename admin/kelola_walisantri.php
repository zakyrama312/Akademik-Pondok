                        ...
                        ?>
                            <tr class="hover:bg-blue-50/30 transition-colors group border-b border-gray-50">
                                ...
                                <td class="p-4">
                                    ...
                                    <p class="text-xs text-gray-500">Ibu:
                                        <?php echo htmlspecialchars($d['nama_ibu'] ?: '-'); ?>
                                    </p>
                                </td>
                ...
                <form action="kelola_walisantri.php" method="POST" class="p-6">
                    <div class="space-y-4">
                        <div class="bg-blue-50 p-3 rounded-lg border border-blue-100 mb-4">
                            <p class="text-xs text-blue-700 font-semibold uppercase tracking-wider">1. Biodata Orang Tua
                            </p>
                        </div>
                        ...
                        <div><label class="block text-sm font-semibold text-gray-700 mb-1">No. Handphone
                                (WA)</label><input type="text" name="no_hp"
                        ...
                        <div><label class="block text-sm font-semibold text-gray-700 mb-1">Alamat
                                Lengkap</label><textarea name="alamat" rows="2"
                        ...
                        <div class="bg-blue-50 p-3 rounded-lg border border-blue-100 mt-6 mb-4">
                            <p class="text-xs text-blue-700 font-semibold uppercase tracking-wider">2. Akun Portal Wali
                            </p>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                ...
                <form action="kelola_walisantri.php" method="POST" class="p-6">
                    ...
                    <div class="space-y-4">
                        <div class="bg-amber-50 p-3 rounded-lg border border-amber-100 mb-4">
                            <p class="text-xs text-amber-700 font-semibold uppercase tracking-wider">Biodata Orang Tua
                            </p>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div><label class="block text-sm font-semibold text-gray-700 mb-1">Nama Ayah</label><input
                        ...
                        <div><label class="block text-sm font-semibold text-gray-700 mb-1">Alamat
                                Lengkap</label><textarea name="alamat" id="input_edit_alamat" rows="2"
                        ...
                        <div class="bg-amber-50 p-3 rounded-lg border border-amber-100 mt-6 mb-4">
                            <p class="text-xs text-amber-700 font-semibold uppercase tracking-wider">Akun Portal Wali
                            </p>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div><label class="block text-sm font-semibold text-gray-700 mb-1">Username</label><input
