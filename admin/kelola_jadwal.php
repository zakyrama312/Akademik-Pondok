                ...
                <tbody class="text-sm text-gray-700">
                    ...
                    ?>
                        <tr class="hover:bg-indigo-50/30 transition-colors border-b border-gray-50">
                            ...
                            <td class="p-4 font-bold text-gray-800"><?php echo htmlspecialchars($m['nama_mapel']); ?></td>
                            <td class="p-4">
        ...
        <div
            ...
            <div>
                <h2 class="text-lg font-bold text-teal-800"><i class="fas fa-calendar-alt mr-2"></i> Jadwal Mengajar
                    Guru</h2>
                <p class="text-sm text-teal-600/80">Tentukan guru mana yang mengajar mata pelajaran di kelas tertentu.
                </p>
            </div>
                ...
                <tbody class="text-sm text-gray-700">
                    ...
                    ?>
                        <tr class="hover:bg-teal-50/30 transition-colors border-b border-gray-50">
                            ...
                            <td class="p-4 text-gray-600 font-medium"><?php echo htmlspecialchars($j['nama_mapel']); ?></td>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="id_pengajar" required
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-teal-500 outline-none bg-gray-50 focus:bg-white">
            ...
            <form action="kelola_jadwal.php" method="POST" class="p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="id_pengajar" id="input_edit_id_pengajar" required
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Mata Pelajaran</label>
                        <select name="id_mapel" id="input_edit_id_mapel" required
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-amber-500 outline-none bg-gray-50 focus:bg-white">
                            <?php
...
<script>
    $(document).ready(function() {
        // Init 2 DataTables sekaligus di satu halaman!
    ...
    function bukaModalJadwalEdit(id_pengampu, id_pengajar, id_mapel, kelas) {
        ...
        document.getElementById('input_edit_id_mapel').value = id_mapel;
